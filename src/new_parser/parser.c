                             ...
                             struct general *general)
{
    ...
    if (!new_if->condition || !new_if->node_then
        || (_else && !new_if->node_else))
    {
                                ...
                                struct general *general)
{
    ...
    if (!new_while->condition || !new_while->node_then)
    {
        warnx("Syntax error: \";\" unexpected");
        return NULL;
    }
                                ...
                                struct general *general)
{
    ...
    if (!new_until->condition || !new_until->node_then)
    {
        warnx("Syntax error: \";\" unexpected");
        return NULL;
    }
                              ...
                              struct general *general)
{
    ...
    if (!new_and->left_child || !new_and->right_child)
    {
        warnx("Syntax error: &&");
        return NULL;
    }
                             ...
                             struct general *general)
{
    ...
    if (!new_or->left_child || !new_or->right_child)
    {
        warnx("Syntax error: ||");
        return NULL;
    }
                                  ...
                                  struct general *general)
{
    ...
    {
        warnx("Syntax error: invalid command");
        return NULL;
    }
    return node_start;
}
...
struct node *parser(char *str, struct general *general)
{
    ...
    while (toks && toks->str)
    {
        ...
        else if (ast && toks->type == NOT)
        {
            ...
            ast = command_token(&toks, ast, general);
